...
<html lang="en">
  ...
  <body>    
        <div class="jumbotron jumbotron-fluid" style="background-color:rgb(75, 204, 198);">        
...
<html lang="en">
  ...
  <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color:rgb(145, 182, 75); ">
...
![output](./static/img/v.JPG)
![output](./static/img/v1.JPG)
![output](./static/img/c.JPG)
![output](./static/img/c1.JPG)

## RESULT:
Thus, a webserver is designed to display house price prediction and is hosted in the URL
http://sumyuktha.student.saveetha.in:8000/HouseModelTraining/ 

& 

http://sumyuktha.student.saveetha.in:8000/HouseModelPrediction/